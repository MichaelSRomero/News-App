...
public class QueryUtils {
    ...
    /** Set of Keys used to parse a URL data */
    private static final String KEY_RESPONSE = "response";
    private static final String KEY_RESULTS = "results";
    private static final String KEY_FIELDS = "fields";
    private static final String KEY_THUMBNAIL = "thumbnail";
    private static final String KEY_HEADLINE = "headline";
    private static final String KEY_FIRST_PUBLICATION_DATE = "firstPublicationDate";
    ...
    private static List<Article> extractFeatureFromJson(String articleJSON) {
        ...
        try {
            ...
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                // for that article.
                JSONObject fields = currentArticle.getJSONObject(KEY_FIELDS);

                // Extract the value for the key called "thumbnail"
                String thumbnail = fields.getString(KEY_THUMBNAIL);

                // Extract the value for the key called "headline"
                String headline = fields.getString(KEY_HEADLINE);

                // Extract the value for the key called "firstPublicationDate"
                String firstPublicationDate = fields.getString(KEY_FIRST_PUBLICATION_DATE);
                ...
                String sectionId = currentArticle.getString(KEY_SECTION_NAME);

                // Extract the value for the key called "url"
                String url = currentArticle.getString(KEY_WEB_URL);

                // Create a new {@link Article} object with the thumbnail, headline, firstPublicationDate,
                // author, sectionId, and url from the JSON response.
                Article article = new Article(thumbnail, headline, firstPublicationDate,
                        author, sectionId, url);
